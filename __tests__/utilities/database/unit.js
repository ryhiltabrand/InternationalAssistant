...
function createTestUserInfo() {
    ...
    testUser.setDateofBirth("2/22/2223")
...
test('create new account', () => {
    ...
    // return expect(testUser.getAccountInformation('cm0IF5KopLgxnJTUtfi403kJuMl2')).resolves.toMatchObject({
    //     name: 'test',
    //     dateofbirth: '2/22/2223',
